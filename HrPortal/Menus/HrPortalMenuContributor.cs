...
namespace HrPortal.Menus;

public class HrPortalMenuContributor : IMenuContributor
{
    ...
    {
        var l = context.GetLocalizer<HrPortalResource>();
        ...
        */
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                HrPortalMenus.BonusSalaries,
                l["Menu:BonusSalaries"],
                url: "/bonus-salaries",
                icon: "fa fa-file-alt",
                requiredPermissionName: HrPortalPermissions.BonusSalaries.Default)
        );

        context.Menu.AddItem(
            new ApplicationMenuItem(
                HrPortalMenus.Holidays,
                l["Menu:Holidays"],
                url: "/holidays",
                icon: "fa fa-file-alt",
                requiredPermissionName: HrPortalPermissions.Holidays.Default)
        );

        context.Menu.AddItem(
            new ApplicationMenuItem(
                HrPortalMenus.Employees,
                l["Menu:Employees"],
                url: "/employees",
                icon: "fa fa-file-alt",
                requiredPermissionName: HrPortalPermissions.Employees.Default)
        );
