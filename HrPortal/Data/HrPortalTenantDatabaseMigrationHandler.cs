...
public class HrPortalTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<HrPortalTenantDatabaseMigrationHandler> _logger;

    public HrPortalTenantDatabaseMigrationHandler(
        HrPortalEFCoreDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<HrPortalTenantDatabaseMigrationHandler> logger)
    {
